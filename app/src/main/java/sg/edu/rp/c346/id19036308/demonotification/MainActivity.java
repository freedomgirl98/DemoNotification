package sg.edu.rp.c346.id19036308.demonotification;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNotify2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Bitmap largeIcon = BitmapFactory.decodeResource(getResources(), R.drawable.sentosa);

                //Build notification
                NotificationCompat.BigPictureStyle bigPicture = new NotificationCompat.BigPictureStyle();
                bigPicture.setBigContentTitle("Welcome to Sentosa!");
                bigPicture.bigPicture(largeIcon);
                bigPicture.setSummaryText("Singapore's premier island getaway");
                NotificationCompat.Builder builder = new NotificationCompat.Builder(MainActivity.this, "default");
                // Set Notification Title
                builder.setContentTitle("Welcome to Sentosa!");
                //Set Notification Content (Body text)
